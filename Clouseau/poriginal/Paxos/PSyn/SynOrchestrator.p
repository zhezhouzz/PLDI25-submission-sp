  ...
  machine Orchestrator {
    start state Init {
      entry {
        ...
        send acceptorMap[Acceptor1], eInit, setting;
        send acceptorMap[Acceptor2], eInit, setting;
        new Client((setting = setting, domain_tVal = domain_tVal, domain_tAcceptorNode = domain_tAcceptorNode, domain_tProposerNode = domain_tProposerNode));
      }
    }
  }
  
  module M = { SynOrchestrator, SynClient, Orchestrator, Client, Proposer, Acceptor, Learner, Timer};
